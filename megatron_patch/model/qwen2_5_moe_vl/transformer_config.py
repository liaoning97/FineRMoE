...
def core_transformer_config_from_args(args, config_class=None):
    ...
    # Config class.
    config_class = config_class or Qwen2VLMoETransformerConfig
...
@dataclass
class Qwen2VLMoETransformerConfig(TransformerConfig):
    ...
    # arguments not in Qwen2VLTransformerConfig but in Qwen2MoETransformerConfig
