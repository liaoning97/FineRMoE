...
from .transformer_config import Qwen2VLMoETransformerConfig
...
class Qwen2_5VLMoEModel(MegatronModule):
    ...
    def __init__(
        self,
        language_transformer_config: Qwen2VLMoETransformerConfig,
