...
def core_transformer_config_from_args(args, config_class=None):
    ...
    kw_args['G_O'] = args.G_O
    kw_args['G_I'] = args.G_I
    kw_args['R_I'] = args.R_I
    kw_args['R_O'] = args.R_O    
    kw_args['moe_concat_proj'] = args.moe_concat_proj
    if args.swiglu:
