...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.reduce_scatter_embeddings = reduce_scatter_embeddings # False
        ...
        self.deterministic_mode = config.deterministic_mode # False
    ...
    def forward(self, input_):
        ...
        if self.reduce_scatter_embeddings: # False
