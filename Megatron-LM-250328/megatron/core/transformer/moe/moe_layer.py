...
from megatron.core.transformer.moe.router import TopKRouter, Concat_Out_Proj
...
class MoELayer(BaseMoELayer):
    ...
    def __init__(
        ...
        # Initialize concat-moe-proj
        if config.moe_concat_proj:
            self.concat_proj = Concat_Out_Proj(config=self.config)
        ...
        elif config.moe_token_dispatcher_type == "alltoall":  # here
    ...
    def forward(self, hidden_states: torch.Tensor):
        ...
        def custom_forward(hidden_states):
            ...
            # hidden_states: [seq_len, 1, hidden_size]
            # probs, routing_map: [seq_len, num_experts]
            ...
            if self.config.moe_concat_proj:
