...
class GPTModel(LanguageModule):
    ...
    def __init__(
        ...
        self.share_embeddings_and_output_weights = share_embeddings_and_output_weights # False

        if hasattr(self.config, 'position_embedding_type'): # rope
        ...
        if hasattr(self.config, 'rotary_base'): # 1000000
        ...
        if self.position_embedding_type == 'rope' and not self.config.multi_latent_attention: # Here
    ...
    def forward(
        ...
        *,
        ...
        if decoder_input is not None:
            ...
            decoder_input = self.embedding(input_ids=input_ids, position_ids=position_ids) # seq_len, micro_bs, hidden_dim
