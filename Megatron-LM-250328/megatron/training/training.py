...
def training_log(loss_dict, total_loss_dict, learning_rate, decoupled_learning_rate, iteration,
    ...
    mem_stats = torch.cuda.memory_stats()
    mem_reserved = mem_stats["reserved_bytes.all.current"]/1024/1024/1024
    mem_allocated = mem_stats["allocated_bytes.all.current"]/1024/1024/1024
        ...
        if args.log_throughput:
            ...
            if args.log_timers_to_tensorboard:
                ...
                if wandb_writer:
                    ...
                    wandb_writer.log({'mem_reserved(GB)': mem_reserved}, iteration)
                    wandb_writer.log({'mem_allocated(GB)': mem_allocated}, iteration)
